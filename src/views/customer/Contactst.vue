...
<template>
  <div class="Contactst">
    ...
    <el-table :data="data.custList" style="width: 100%">
      ...
      <el-table-column prop="contactIsPolicy" :formatter="IsPolicy" label="是否决策人" width="200" />
      <el-table-column prop="contactRelation" :formatter="Relation" label="与客户的关系" width="200" />
    ...
    v-if="addCustomer"
    v-model:addCustomer="addCustomer"></addlxrs>
  </div>
</template>
